...
public class AccountManager : MonoBehaviour
{
    ...
    public static event AccountEvent OnLoggedIn;
    public static event AccountEvent OnSignedOut;
    public static event AccountEvent OnRegistered;
        ...
        EasyTables.Instance.SelectFiltered<User>(query, selectResponse =>
        {
            if (selectResponse.Status == CallBackResult.Success)
            {
                ...
                if (inputAcceptable)
                {
                    ...
                    if (OnStatusUpdate != null) OnStatusUpdate("Username or password is incorrect!");
